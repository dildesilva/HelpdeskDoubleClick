...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/manegeBranch.css')}}">
    @vite(['public/css/dash.css','public/css/manegeBranch.css'])
</head>
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <div class="scrolwithoverflowadmindash">
                ...
                <li>
                    <a href="{{url('/manageBranch')}}" class="active">
    ...
    <section class="home-section">
        ...
        <div class="branchdeta">
            <div class="branchdetaBB">
                <h1 class="page-title">All Branches</h1>
                <div class="table-container">
                    <div class="filter-box">
                        <span class="input-group-text"><i class="bi bi-search"></i></span>
                        <input type="text" id="searchInput" class="form-control" placeholder="Search by name or company" onkeyup="filterTable()">
                    </div>
                    <table id="branchTable">
                        ...
                        <tbody>
                            @foreach ($branchdeta as $data)
                            <tr>
                                <td>{{$data->name}}-{{$data->company}}</td>
                                <td>{{$data->contact}}</td>
                                <td>{{$data->location}}</td>
                                <td>{{$data->company}}</td>
